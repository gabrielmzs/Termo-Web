import { JogoTermo } from './JogoTermo.js';

export default class TelaTermo2 {
    private pnlTermo: HTMLDivElement;
    private linhas: HTMLDivElement[];
    private letras: HTMLDivElement[];
    private pnlTeclado: HTMLDivElement;
    private btnEnter: HTMLButtonElement;
    private linhaPalpite: number = 1;
    private letraLinha: number = 1;
    private palavraSecreta: string = '';
    private palavras: string[] = [];
    private msgFinal: HTMLElement;
    private btnVoltar: HTMLButtonElement;
    private jogarNovamente: HTMLButtonElement;
